...
namespace SearchTests
{
    ...
    public class FinderBinaryTests
    {
        ...
        {
            int result = FindElement.BinarySearch(_array, 1);
        ...
        {
            int result = FindElement.BinarySearch(_array, 20);
        ...
        {
            int result = FindElement.BinarySearch(_array, 0);
        ...
        {
            int result = FindElement.BinarySearch(_array, 21);
