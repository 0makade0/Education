...
{
    [TestFixture]
    public class FastLinearSearchTests
    {
        ...
        {
            int result = FindElement.FastLinearSearch(_array, 1);
        ...
        {
            int result = FindElement.FastLinearSearch(_array, 20);
        ...
        {
            int result = FindElement.FastLinearSearch(_array, 0);
        ...
        {
            int result = FindElement.FastLinearSearch(_array, 21);
